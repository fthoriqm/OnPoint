...
public class OnPointApplication {

    public static void main(String[] args) {
        SpringApplication.run(OnPointApplication.class, args);

//        Scanner scan = new Scanner(System.in);
//
//        // Connecting to database Mechanism
...
//
//        //Putting account into the application
...
//
//        //Reloading data yang from the database into the List on the program
